...
pub fn generate_nekobox_sn_link(
    address: String,
    port: u32,
    remarks: String,
    ...
    let config = WireguardConfig {
        ...
        peer_pre_shared_key: shared_key_value,
        mtu: mtu_value,
        reserved: reserved_value, // 4个字符的，https://gchq.github.io/CyberChef/#recipe=From_Decimal('Comma',false)To_Base64('A-Za-z0-9%2B/%3D')&input=MTIxLDEwMiw3Mg
    };
